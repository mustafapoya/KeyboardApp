...
for button in keys:
    if button != "SPACE":
        but = tk.Button(Keyboard_App, text=button, width=5, bg="black", fg="white",
                        highlightthickness=4, activebackground="gray", activeforeground="red",
                        highlightcolor="red", relief="raised",
                        padx=12, pady=4, bd=4,
    ...
    if button == "SPACE":
        but = tk.Button(Keyboard_App, text=button, width=60, bg="black", fg="white",
                        highlightthickness=4, activebackground="gray65", activeforeground="red",
                        highlightcolor="red", relief="raised",
                        padx=4, pady=4, bd=4,
                        command=lambda x=button, i=varRow - 1, j=varColumn: select(x, i, j))
